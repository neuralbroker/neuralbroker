...
- [EsenceLab](https://github.com/neuralbroker/esencelab): AI hiring platform, 3-service monorepo. Groq resume parsing cut shortlisting by 60% across 200+ resumes. JWT + Supabase RLS auth. 2nd at Innovision (30+ teams).
